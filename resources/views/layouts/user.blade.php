...
<body>
  ...
  <header id="header">
    <div class="container">
      <div id="logo" class="pull-left">
        <a href="#hero">
          <img src="{{asset('user/images/LOGO-PEMKOT-NONTEXT.png')}}" style="margin-right:5px" />
        </a>
      </div>
      ...
      <nav id="nav-menu-container">
        <ul class="nav-menu">
          ...
          <li class="{{$url=='blog'?'menu-active':''}}">
            <a href="{{url('blog')}}">Tentang Solo</a>
          </li>
          <li class="{{$url=='destination'?'menu-active':''}}">
            <a href="{{url('destination')}}">Portal Layanan</a>
          </li>
          <li class="{{$url=='destination'?'menu-active':''}}">
            <a href="{{url('destination')}}">Berita</a>
          </li>
  ...
  <footer id="footer">
    ...
    <div class="container">
      <div class="copyright">
        &copy; Copyright <strong>Iskandar Abdul Azis Saputra</strong>. All Rights Reserved
      </div>
      <div class="credits">
